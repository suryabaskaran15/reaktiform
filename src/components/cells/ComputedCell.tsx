...
type ComputedCellProps = {
  ...
  colDef: ColumnDef
  className?: string
  editable?: boolean  // true when editableWhenComputed and not in edit mode
}

export function ComputedCell({ value, colDef, className, editable = false }: ComputedCellProps) {
  ...
  return (
    <div
      ...
      title={editable ? 'Click to edit (computed — override allowed)' : 'Computed — auto-calculated'}
